!function (t) {
    ...
    c.prototype = {
        constructor: c, _parseAttr: function (t, i) {
            ...
            var e, a, n = this;
            n.initTouch(), n.$rating.on("click", function (t) {
                $.ajax({
                    url: window.location.pathname + '/' + n.calculate(n.getPosition(t)).val + "/",
                });
                n.inactive || (e = n.getPosition(t), n.setStars(e), n.$element.trigger("change").trigger("rating.change", [n.$element.val(), n.$caption.html()]), n.starClicked = !0)
